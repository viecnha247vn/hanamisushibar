...
| Ảnh món ăn | 11 ảnh của quán gắn vào 11 danh mục (`static/meny/<id>-{s,m,l}.webp/jpg` cho banner 16:7 trên `/meny`, `<id>-sq` vuông cho 6 thẻ nổi bật trang chủ). Mỗi ảnh có ba cỡ, WebP kèm JPG dự phòng, tải lười (lazy) nên trang menu vẫn nhẹ. Thêm ảnh cho danh mục mới: đặt file đúng tên vào `static/meny/`, build tự nhận, không cần sửa code |
